...
class SharerUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ShareRecordUpdateManyWithoutSharersInput,
  })
  @ValidateNested()
  @Type(() => ShareRecordUpdateManyWithoutSharersInput)
  @IsOptional()
  @Field(() => ShareRecordUpdateManyWithoutSharersInput, {
    nullable: true,
  })
  shareRecords?: ShareRecordUpdateManyWithoutSharersInput;
}

export { SharerUpdateInput as SharerUpdateInput };
