...
@InputType()
class ShareRecordCreateNestedManyWithoutSharersInput {
...
export { ShareRecordCreateNestedManyWithoutSharersInput as ShareRecordCreateNestedManyWithoutSharersInput };
