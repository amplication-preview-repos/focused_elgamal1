...
@InputType()
class ParticipantCreateNestedManyWithoutLotteriesInput {
...
export { ParticipantCreateNestedManyWithoutLotteriesInput as ParticipantCreateNestedManyWithoutLotteriesInput };
